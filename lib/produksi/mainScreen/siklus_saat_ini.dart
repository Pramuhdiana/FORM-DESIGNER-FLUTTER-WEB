...
class SiklusSaatIni extends StatefulWidget {
  const SiklusSaatIni({super.key});

  @override
  State<SiklusSaatIni> createState() => _SiklusSaatIniState();
}
...
class _SiklusSaatIniState extends State<SiklusSaatIni> {
  ...
  List<int>? _listValuePencapaian = [100, 50, 20, 500];
  ...
  initState() {
    ...
    chartDataPasangBatu = [
      ChartData(
          xValue: 'CARKIYAD', secondSeriesYValue: 2, text: 'CARKIYAD \n ${2}'),
      ChartData(xValue: 'BUDI', secondSeriesYValue: 5, text: 'BUDI \n ${5}'),
      ChartData(xValue: 'ARI', secondSeriesYValue: 1, text: 'ARI \n ${1}'),
      ChartData(xValue: 'ASEP', secondSeriesYValue: 7, text: 'ASEP \n ${7}'),
      ChartData(xValue: 'ABDUL', secondSeriesYValue: 4, text: 'ABDUL \n ${4}'),
    ];
    chartDataKiri = [
      ChartData(
          xValue: 'Siklus Bulan Lalu',
          secondSeriesYValue: 7,
          text: 'Siklus Bulan Lalu \n ${40}'),
      ChartData(
          xValue: 'Siklus Saat Ini',
          secondSeriesYValue: 4,
                        ...
                        child: Column(
                            ...
                            children: [
                              Container(
                                ...
                                child: const Text(
                                  'Report Untuk SCM Siklus Saat Ini',
                                  style: TextStyle(
                                      color: Colors.black,
  ...
  chartPieKiri() {
    return SizedBox(
        ...
        child: SfCircularChart(
          legend: Legend(isVisible: true, position: LegendPosition.top),
          series: _getRadiusKiri(),
          tooltipBehavior:
              TooltipBehavior(enable: true, format: 'Total: point.y'),
        ));
  }

  List<PieSeries<ChartData, String>> _getRadiusKanan() {
    return <PieSeries<ChartData, String>>[
      PieSeries<ChartData, String>(
          ...
          dataSource: <ChartData>[
            ChartData(x: 'Week 1', y: 80, text: '70%'),
            ChartData(x: 'Week 2', y: 100, text: '80%'),
            ChartData(x: 'Week 3', y: 120, text: '90%'),
            ChartData(x: 'Week 4', y: 50, text: '100%'),
          ],
  ...
  List<PieSeries<ChartData, String>> _getRadiusKiri() {
    return <PieSeries<ChartData, String>>[
      PieSeries<ChartData, String>(
          onPointTap: (event) {
            // ignore: unused_local_variable
    ...
    return [
      for (var i = 0; i < count; i++)
        DataRow(cells: [
          DataCell(Container(
              padding: const EdgeInsets.all(5),
              child: Center(child: Text(data[i].brand)))),
          DataCell(Container(
              padding: const EdgeInsets.all(5),
              child: Center(child: Text(_listValuePencapaian![i].toString())))),
          // DataCell(Container(
