...
class ReparasiScreen extends StatefulWidget {
  const ReparasiScreen({super.key});
  @override
  State<ReparasiScreen> createState() => _ReparasiScreenState();
}
...
class _ReparasiScreenState extends State<ReparasiScreen> {
  var nowSiklus = '';
  var nowBulan = '';
  ...
  _getData(chooseSiklus) async {
    ...
    if (response.statusCode == 200) {
      ...
      var filterByOrul = alldata.where((element) =>
          element.statusBackPosisi.toString().toLowerCase() == 'reparasi');
