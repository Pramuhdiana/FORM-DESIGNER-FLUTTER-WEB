...
class Poleshing1Screen extends StatefulWidget {
  const Poleshing1Screen({super.key});
  @override
  State<Poleshing1Screen> createState() => _Poleshing1ScreenState();
}

class _Poleshing1ScreenState extends State<Poleshing1Screen> {
  List<ProduksiModel>? _listPoleshing1;
  List<ProduksiModel>? _filterListPoleshing1;
  TextEditingController controller = TextEditingController();
  bool isLoading = false;
  String divisi = 'poleshing 1';
  //! fungsi go to up
  ...
  initState() {
    ...
    scrollController.addListener(() async {
      if (scrollController.position.pixels ==
        ...
        if (page != _listPoleshing1!.length) {
                        ...
                        child: Align(
                          ...
                          child: TextField(
                            ...
                            onChanged: (value) {
                              ...
                              _listPoleshing1 = _filterListPoleshing1!
                                  .where((element) =>
                                      element.nama!
                                          .toLowerCase()
                  ...
                  isLoading == true
                      ...
                      : Expanded(
                          child: SingleChildScrollView(
                              ...
                              child: SizedBox(
                                  width: 1200, child: _dataTablePoleshing1()))),
                  const SizedBox(
                    height: 20,
                  ),
                ],
  ...
  Future<List<ProduksiModel>> _getData() async {
    ...
    if (response.statusCode == 200) {
      ...
      _filterListPoleshing1 = g;
      _listPoleshing1 = g;

      setState(() {
        _filterListPoleshing1 = g;
        _listPoleshing1!.sort((a, b) => b.id!.compareTo(a.id!));
        isLoading = false;
      });
      return g;
    } else {
  ...
  DataTable _dataTablePoleshing1() {
    return DataTable(
        headingTextStyle:
        ...
        rows: _createRows(_listPoleshing1, 20));
    // rows: _createRows(_listPoleshing1, _listPoleshing1!.length));
  }
