...
class _HomeScreenAdminState extends State<HomeScreenAdmin> {
  ...
  Future<List<FormDesignerModel>> _getDataJenisBarang(chooseSiklus, nama) async {
   setState(() {
                                                      ...
                                                      :
                                                              ListView
                                                                  ...
                                                                  itemBuilder:
                                                                    ...
                                                                    var dataUniq = uniqListJenisBarang![index];
                                                                    return Container(
                                                                      padding:
                                                                          const EdgeInsets
                                                                              .all(
