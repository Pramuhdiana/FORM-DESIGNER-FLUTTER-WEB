...
class ExcelAdmin {
  ...
  Future<String> getImage(String urlEndpoint) async {
    print('get image');
    //? get image
    var apiUrl = ApiConstants.baseUrlImage + urlEndpoint;
    try {
      var responseImage = await http.get(Uri.parse(
          'https://cdn.dummyjson.com/cache/200x100/bitter-16/cccccc-black/7a498f9c8ff4ecf6cac725ad5c36270c.png'));
    ...
    // } else {
    //   // ignore: avoid_print
    //   print('failed to fetch image. Status code : ${responseImage.statusCode}');
    //   throw Exception('failed get gambar');
    //   // ignore: avoid_print
    // }
  }
...
//get data
    ...
    var head37 = sheet.cell(CellIndex.indexByString("CH1"));
    head37.value = "Gambar";
    head37.cellStyle = headStyle;
