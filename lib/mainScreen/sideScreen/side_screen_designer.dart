...
class MainViewDesigner extends StatefulWidget {
  //fungsi untuk menerima data
  int col = 0;
  //init data
  MainViewDesigner({super.key, required this.col});

  @override
  // ignore: library_private_types_in_public_api
  _MainViewDesignerState createState() => _MainViewDesignerState();
}

class _MainViewDesignerState extends State<MainViewDesigner> {
  @override
  void initState() {
    super.initState();
  }
