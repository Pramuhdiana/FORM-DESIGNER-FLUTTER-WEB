...
class MainViewAddPr extends StatefulWidget {
  //fungsi untuk menerima data
  int col = 0;
  final VoidCallback? onBackPressed;
  //init data
  MainViewAddPr({super.key, required this.col, this.onBackPressed});

  @override
  // ignore: library_private_types_in_public_api
  _MainViewAddPrState createState() => _MainViewAddPrState();
}

class _MainViewAddPrState extends State<MainViewAddPr> {
  @override
  void initState() {
    super.initState();
  }
