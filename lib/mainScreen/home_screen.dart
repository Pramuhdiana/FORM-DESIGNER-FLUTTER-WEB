...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Future<List<FormDesignerModel>> _getAllData(month) async {
  ...
  Future<List<FormDesignerModel>> _getData(chooseSiklus) async {
    final response = await http.get(
        Uri.parse(ApiConstants.baseUrl + ApiConstants.getListFormDesigner));
    if (response.statusCode == 200) {
      List jsonResponse = json.decode(response.body);
  ...
  Future<List<FormDesignerModel>> _getKelasHarga(chooseSiklus) async {
    final response = await http.get(
        Uri.parse(ApiConstants.baseUrl + ApiConstants.getListFormDesigner));
    if (response.statusCode == 200) {
      List jsonResponse = json.decode(response.body);
