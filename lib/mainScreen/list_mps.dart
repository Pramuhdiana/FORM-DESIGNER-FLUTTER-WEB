                          ...
                          Container(
                            ...
                            child: Theme(
                              ...
                              child: PaginatedDataTable(
                                  ...
                                  // rowsPerPage: 25,
                                  columnSpacing: 0,
                                  columns: sharedPreferences!.getString(
                                                  'divisi') ==
                                              'produksi' ||
                                          sharedPreferences!
                                                  .getString('divisi') ==
                                          ...
                                          DataColumn(
                                              ...
                                              onSort: (columnIndex, _) {
                                                setState(() {
                                                  ...
                                                  if (sort == true) {
                                                    sort = false;
                                                    filterDataProduksi!.sort((a,
                                                            b) =>
                                                        a.keteranganStatusBatu!
                                                            .toLowerCase()
                                                            .compareTo(b
                                                                .keteranganStatusBatu!
                                                                .toLowerCase()));
                          ...
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              children: [
                                ...
                                // ),
                                Text(
                                  'Pilih Artist ${listDivisi[j]} - $posisi - ${listSubDivisiArtistFinishing.length}',
                                  style: const TextStyle(
                                      color: Colors.black,
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
                        ...
                        content: SizedBox(
                          child: SingleChildScrollView(
                            ...
                            child: Column(
                              children: [
                                Text(
                                  'Pilih Artist ${listDivisi[j]} - $posisi',
                                  style: const TextStyle(
                                      color: Colors.black,
                                      fontSize: 18,
                                      fontWeight: FontWeight.bold),
