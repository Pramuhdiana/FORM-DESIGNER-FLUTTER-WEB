...
class _ListMpsScreenState extends State<ListMpsScreen> {
      ...
      DataColumn(
          ...
          onSort: (columnIndex, _) {
            setState(() {
              ...
              if (sort == true) {
                sort = false;
                myDataProduksi!.sort((a, b) => a.kodeDesignMdbc!
                    .toLowerCase()
                    .compareTo(b.kodeDesignMdbc!.toLowerCase()));
              } else {
                sort = true;
                myDataProduksi!.sort((a, b) => b.kodeDesignMdbc!
                    .toLowerCase()
      ...
      DataColumn(
          ...
          onSort: (columnIndex, _) {
            setState(() {
              ...
              if (sort == true) {
                sort = false;
                myDataProduksi!.sort((a, b) => a.kodeMarketing!
                    .toLowerCase()
                    .compareTo(b.kodeMarketing!.toLowerCase()));
              } else {
                sort = true;
                myDataProduksi!.sort((a, b) => b.kodeMarketing!
                    .toLowerCase()
                    .compareTo(a.kodeMarketing!.toLowerCase()));
              }
            });
      ...
      DataColumn(
          ...
          onSort: (columnIndex, _) {
            setState(() {
              ...
              if (sort == true) {
                sort = false;
                myDataProduksi!.sort((a, b) => a.posisi!.compareTo(b.posisi!));
              } else {
                sort = true;
                myDataProduksi!.sort((a, b) => b.posisi!.compareTo(a.posisi!));
              }
            });
          }),
      ...
      DataColumn(
          ...
          onSort: (columnIndex, _) {
            setState(() {
              ...
              if (sort == true) {
                sort = false;
                myDataProduksi!.sort((a, b) => a.keteranganStatusBatu!
                    .toLowerCase()
                    .compareTo(b.keteranganStatusBatu!.toLowerCase()));
              } else {
                sort = true;
                myDataProduksi!.sort((a, b) => b.keteranganStatusBatu!
                    .toLowerCase()
                    .compareTo(a.keteranganStatusBatu!.toLowerCase()));
              }
            });
          }),
      ...
      DataColumn(
          ...
          onSort: (columnIndex, _) {
            setState(() {
              ...
              if (sort == true) {
                sort = false;
                myDataProduksi!.sort((a, b) => a.keteranganStatusAcc!
                    .toLowerCase()
                    .compareTo(b.keteranganStatusAcc!.toLowerCase()));
              } else {
                sort = true;
                myDataProduksi!.sort((a, b) => b.keteranganStatusAcc!
                    .toLowerCase()
                    .compareTo(a.keteranganStatusAcc!.toLowerCase()));
              }
            });
          }),
          ...
          onSort: (columnIndex, _) {
            setState(() {
              ...
              if (sort == true) {
                sort = false;
                myDataProduksi!.sort((a, b) =>
                    a.tema!.toLowerCase().compareTo(b.tema!.toLowerCase()));
              } else {
                sort = true;
                myDataProduksi!.sort((a, b) =>
                    b.tema!.toLowerCase().compareTo(a.tema!.toLowerCase()));
              }
            });
          }),
          ...
          onSort: (columnIndex, _) {
            setState(() {
              ...
              if (sort == true) {
                // myCrm.sort((a, b) => a['estimasiHarga'].)
                sort = false;
                myDataProduksi!.sort((a, b) => a.brand!.compareTo(b.brand!));
                // onsortColum(columnIndex, ascending);
              } else {
                sort = true;
                myDataProduksi!.sort((a, b) => b.brand!.compareTo(a.brand!));
              }
            });
          }),
          ...
          onSort: (columnIndex, _) {
            setState(() {
              ...
              if (sort == true) {
                ...
                sort = false;
                myDataProduksi!.sort(
                    (a, b) => a.estimasiHarga!.compareTo(b.estimasiHarga!));
                // onsortColum(columnIndex, ascending);
              } else {
                sort = true;
                myDataProduksi!.sort(
                    (a, b) => b.estimasiHarga!.compareTo(a.estimasiHarga!));
              }
            });
          }),
      //tanggal in produksi
      DataColumn(
          ...
          onSort: (columnIndex, _) {
            setState(() {
              ...
              if (sort == true) {
                sort = false;
                myDataProduksi!.sort((a, b) => a.tanggalInProduksi!
                    .toLowerCase()
                    .compareTo(b.tanggalInProduksi!.toLowerCase()));
              } else {
                sort = true;
                myDataProduksi!.sort((a, b) => b.tanggalInProduksi!
                    .toLowerCase()
                    .compareTo(a.tanggalInProduksi!.toLowerCase()));
              }
            });
          }),
    ];
  ...
  List<DataRow> rowsData(int count) {
    return [
  ...
  _getDataBySiklusProduksi(chooseSiklus, chooseWeek, chooseJenisBarang) async {
    ...
    if (response.statusCode == 200) {
      ...
      for (var i = 0; i < alldata.length; i++) {
        sumEmas += alldata[i].beratEmas!;
        sumDiamond += alldata[i].totalCarat!;
      }
      sumSpk = alldata.length;
  ...
  mpsProduksi() {
    ...
    return SizedBox(
      ...
      child: Stack(clipBehavior: Clip.none, children: <Widget>[
        // siklusDesigner.isEmpty ? const SizedBox() : dataTable(),
        Column(
                          ...
                          child: SizedBox(
                            ...
                            child: DropdownSearch<String>(
                              ...
                              onChanged: (item) async {
                                ...
                                await _getDataBySiklusProduksi(siklusDesigner,
                                    pilihWeek, pilihJenisBarang);
                                setState(() {
                                  isLoading = false;
                                });
                              },
          ...
          onSort: (columnIndex, _) {
            setState(() {
              ...
              if (sort == true) {
                sort = false;
                myDataProduksi!
                    .sort((a, b) => a.beratEmas!.compareTo(b.beratEmas!));
              } else {
                sort = true;
                myDataProduksi!
                    .sort((a, b) => b.beratEmas!.compareTo(a.beratEmas!));
              }
            });
          }),
      DataColumn(label: _verticalDivider),
          ...
          onSort: (columnIndex, _) {
            setState(() {
              ...
              if (sort == true) {
                sort = false;
                myDataProduksi!
                    .sort((a, b) => a.totalCarat!.compareTo(b.totalCarat!));
              } else {
                sort = true;
                myDataProduksi!
                    .sort((a, b) => b.totalCarat!.compareTo(a.totalCarat!));
              }
            });
          }),
      DataColumn(label: _verticalDivider),
