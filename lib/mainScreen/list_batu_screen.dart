...
class _ListBatuScreenState extends State<ListBatuScreen> {
  ...
  Future<List<ListBatuModel>> _getDataByPagenLimit() async {
    final response = await http.get(Uri.parse(
        '${ApiConstants.baseUrl}${ApiConstants.getDataBatu}?page=$page&limit=$limit'));
                      ...
                      TextButton(
                        onPressed: () async {
                          ...
                          Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (c) => const ListBatuScreen()));
                          showDialog<String>(
                              context: context,
                              builder: (BuildContext context) =>
                                  const AlertDialog(
