                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          labelText: beratEmas.text.isEmpty ? "" : "B.Emas",
                          border: OutlineInputBorder(
                              borderRadius: BorderRadius.circular(5.0)),
                        ),
                      ),
              ...
              Row(
                children: [
                  ...
                  Container(
                    ...
                    width: wid,
                    height: kodeDesignMdbc.text.length > 10 ? 60 : 30,
                    child: TextFormField(
                      enabled: false,
                      maxLines: kodeDesignMdbc.text.length > 10 ? 2 : 1,
                      style: const TextStyle(
                          fontSize: 12,
                          color: Colors.black,
                          fontWeight: FontWeight.bold),
                      ...
                      decoration: InputDecoration(
                        labelText:
                            kodeDesignMdbc.text.isEmpty ? "" : "Kode MDBC",
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(5.0)),
                      ),
                    ),
              ...
              Row(
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.only(right: 0, bottom: 3),
                    width: wid,
                    height: namaDesigner.text.length > 10 ? 60 : 30,
                    child: TextFormField(
                      enabled: false,
                      maxLines: namaDesigner.text.length > 10 ? 2 : 1,
                      style: const TextStyle(
                          fontSize: 12,
                          color: Colors.black,
                          fontWeight: FontWeight.bold),
              ...
              Row(
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.only(right: 0, bottom: 3),
                    width: wid,
                    height: namaModeller.text.length > 12 ? 60 : 30,
                    child: TextFormField(
                      enabled: false,
                      maxLines: namaModeller.text.length > 12 ? 2 : 1,
                      style: const TextStyle(
                          fontSize: 12,
                          color: Colors.black,
                          fontWeight: FontWeight.bold),
              ...
              Row(
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.only(right: 0, bottom: 3),
                    width: wid,
                    height: kodeDesign.text.length > 12 ? 60 : 30,
                    child: TextFormField(
                      enabled: false,
                      maxLines: kodeDesign.text.length > 12 ? 2 : 1,
                      style: const TextStyle(
                          fontSize: 12,
                          color: Colors.black,
                          fontWeight: FontWeight.bold),
                      ...
                      decoration: InputDecoration(
                        labelText: kodeDesign.text.isEmpty ? "" : "Kode Design",
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(5.0)),
                      ),
                    ),
              ...
              Row(
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.only(right: 0, bottom: 3),
                    width: wid,
                    height: brand.text.length > 12 ? 60 : 30,
                    child: TextFormField(
                      enabled: false,
                      maxLines: brand.text.length > 12 ? 2 : 1,
                      style: const TextStyle(
                          fontSize: 12,
                          color: Colors.black,
                          fontWeight: FontWeight.bold),
              ...
              Row(
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.only(right: 0, bottom: 3),
                    width: wid,
                    height: kategoriBarang.text.length > 12 ? 60 : 30,
                    child: TextFormField(
                      enabled: false,
                      maxLines: kategoriBarang.text.length > 12 ? 2 : 1,
                      style: const TextStyle(
                          fontSize: 12,
                          color: Colors.black,
                          fontWeight: FontWeight.bold),
              ...
              Row(
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.only(right: 0, bottom: 3),
                    width: wid,
                    height: color.text.length > 12 ? 60 : 30,
                    child: TextFormField(
                      enabled: false,
                      maxLines: color.text.length > 12 ? 2 : 1,
                      style: const TextStyle(
                          fontSize: 12,
                          color: Colors.black,
                          fontWeight: FontWeight.bold),
              ...
              Row(
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.only(right: 0, bottom: 3),
                    width: wid,
                    height: jenisBarang.text.length > 12 ? 60 : 30,
                    child: TextFormField(
                      enabled: false,
                      maxLines: jenisBarang.text.length > 12 ? 2 : 1,
                      style: const TextStyle(
                          fontSize: 12,
                          color: Colors.black,
                          fontWeight: FontWeight.bold),
              ...
              Row(
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.only(right: 0, bottom: 3),
                    width: wid,
                    height: ringSize.text.length > 12 ? 60 : 30,
                    child: TextFormField(
                      enabled: false,
                      maxLines: ringSize.text.length > 12 ? 2 : 1,
                      style: const TextStyle(
                          fontSize: 12,
                          color: Colors.black,
                          fontWeight: FontWeight.bold),
              ...
              Row(
                children: [
                  ...
                  Container(
                    padding: const EdgeInsets.only(right: 0, bottom: 3),
                    width: wid,
                    height: estimasiHarga.text.length > 12 ? 60 : 30,
                    child: TextFormField(
                      enabled: false,
                      maxLines: estimasiHarga.text.length > 12 ? 2 : 1,
                      style: const TextStyle(
                          fontSize: 12,
                          color: Colors.black,
                          fontWeight: FontWeight.bold),
                      ...
                      decoration: InputDecoration(
                        labelText:
                            estimasiHarga.text.isEmpty ? "" : "Estimasi Harga",
                        border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(5.0)),
                      ),
                    ),
