...
List<KebutuhanBatuModel> allcrm(String str) => List<KebutuhanBatuModel>.from(
    json.decode(str).map((x) => KebutuhanBatuModel.fromJson(x)));

String allcrmToJson(List<KebutuhanBatuModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
initState() {}

class KebutuhanBatuModel {
  int? id;
  String? batu1;
  int? qtyBatu1;
  String? batu2;
  ...
  factory KebutuhanBatuModel.fromJson(Map<String, dynamic> json) =>
      KebutuhanBatuModel(
        id: json["id"] ?? 0,
        batu1: json["batu1"] ?? '',
